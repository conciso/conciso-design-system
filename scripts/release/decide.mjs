// Release-Entscheidung des Publish-Workflows (ADR-0010): was dieser Lauf tun soll.
//
...
export function decide({ latestTag, tagHasRelease, tagIsAnnotated, cssVersions, libVersions, engineVersion, dry }) {
  ...
  //    Alt-Tag (vor ADR-0010) lässt sich so nicht bauen; ein Versuch würde jeden weiteren
