...
Ein [Release](CONTEXT.md#release) entsteht ohne Handschritt aus den Commits auf `main` (siehe [ADR-0009](docs/adr/0009-release-ausloesung-und-versionsquelle.md)). Das CHANGELOG wird dafür **nicht mehr** von Hand ergänzt — an seine Stelle tritt der Commit selbst.
