...
- **Der 1,3:1-Faustwert ist ein Leuchtdichte-Wert und unterschätzt satte Farbtöne.** Zwei Flächen können den Quotienten erfüllen und trotzdem nicht als Stufe lesen, wenn der Unterschied fast nur in Sättigung und Farbton liegt. Beispiel: die vier Dark-Füllungen liegen alle bei 1,32 bis 1,33:1 gegen die Karte, ES hat davon mit ΔE76 = 48,7 den größten Farbabstand, aber alle vier haben nur **ΔL\* ≈ 8** Helligkeitsabstand, und ein satter Blauton auf gleicher Helligkeit liest als dunkler Fleck statt als hellere Fläche. Bei gesättigten Füllungen deshalb zusätzlich ΔL\* prüfen, nicht nur den Kontrastwert.
