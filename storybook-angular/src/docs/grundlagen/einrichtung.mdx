...
nur gegen die Angular-Lib, eine Erweiterung auf `@conciso/design-system` ist als
Folge-Ticket vorgesehen.
...
Den MCP-Server gibt es erst ab der ersten Version nach 2.1.1; ist dein Stand älter,
