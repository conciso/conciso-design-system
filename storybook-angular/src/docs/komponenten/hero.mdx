...
dem Hero-Bild liegt. Für den Hero gibt es kein eigenes Angular-Bauteil; die Klassen
kommen direkt aus der CSS-Schicht. Der Slider-Hero teilt seine Track-Mechanik mit
